 ...
 */
final class Version20201223090549 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD image VARCHAR(500) DEFAULT NULL, DROP images_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD images_id INT DEFAULT NULL, DROP image');
