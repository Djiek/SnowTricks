 ...
 */
final class Version20201221085349 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, images_id INT DEFAULT NULL, login VARCHAR(60) NOT NULL, password VARCHAR(30) NOT NULL, mail VARCHAR(255) NOT NULL, token VARCHAR(500) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649D44F05E5 (images_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649D44F05E5 FOREIGN KEY (images_id) REFERENCES images (id)');
